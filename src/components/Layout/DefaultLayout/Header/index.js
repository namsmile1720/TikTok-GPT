            ...
            <div className={cx('content')}>
                ...
                <div className={cx('tool')}>
                    {user ? (
                        ...
                        <>
                            <Button primary medium iconRight={<FontAwesomeIcon icon={faRightFromBracket} />}>
                                Loggin
                            </Button>
                        </>
                    )}

                    <Menu items={user ? USER_LOGGIN : MENU_ITEM}>
                        {user ? (
                            <Image
                                alt="users"
                                className={cx('avatar')}
                                src="https://p16-sign-va.tiktokcdn.com/tos-maliva-avt-0068/f90cc529e5bacc99b1459a81ab73ca87~c5_100x100.jpeg?x-expires=1679493600&x-signature=KchCvTC4NLJ6rcMcf7HxqMRTNUs%3D"
                            ></Image>
                        ) : (
